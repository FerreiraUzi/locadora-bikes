...
try (Connection con = ConnectionFactory.getConnection()) {String sql = "INSERT INTO locacao(cliente_id, bicicleta_id,data_inicio, data_fim, status) VALUES (?, ?, ?, ?, 'ativa')";
...
stmt.executeUpdate();
// Atualizar status da bicicleta para 'locada'
String sqlAtualiza = "UPDATE bicicleta SET status='locada' WHEREid=?";
...
l.setBicicletaId(rs.getInt("bicicleta_id"));l.setDataInicio(rs.getTimestamp("data_inicio"));
